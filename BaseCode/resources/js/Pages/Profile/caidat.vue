        ...
        <div class="bao_item">
            <div class="infor_noidung">
                ...
                <div class="password-form">
                    <h4>Đổi mật khẩu</h4>
                    <div v-if="passwordSuccess" style="color: #155724; background-color: #d4edda; padding: .75rem 1.25rem; margin-bottom: 1rem; border-radius: 0.375rem; font-size: 14px; font-weight: 500;">
                    ...
                    <form @submit.prevent="showOtpStep ? updatePassword() : requestOtp()">
                        ...
                        <!-- Trường OTP -->
                        <div v-if="showOtpStep" style="margin-bottom: 20px; background-color: #f8fafc; padding: 20px; border-radius: 6px; border: 1px solid #e2e8f0;">
