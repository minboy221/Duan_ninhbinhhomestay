    ...
    <LandlordLayout>
        <div class="space-y-6">
            ...
            >
                ...
                <Link
                    :href="route('landlord.listings.create')"
            ...
            <!-- Listings Cards Deck -->
            <div
                v-if="!listings.data || listings.data.length === 0"
            ...
            >
                ...
                <span
                    >Chưa có tin đăng nào. Hãy tạo tin đăng đầu tiên của
                    bạn!</span
                >
            </div>
            <div v-else class="space-y-4">
                <div
                    v-for="ls in listings.data"
                    :key="ls.id"
                ...
                >
                    ...
                    >
                        <img
                            v-if="ls.image && ls.image.length > 0"
                            :src="ls.image[0]"
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between gap-4">
                        <div class="space-y-2">
                            <h3
                                class="text-sm font-bold text-slate-800 leading-snug"
                            >
                                {{ ls.title }}
                            </h3>
                            <div
                            ...
                            >
                                <span class="flex items-center gap-1"
                                    ><i
                                        class="bi bi-house-door text-emerald-600"
                                    ></i>
                                    {{ ls.room?.room_number }}</span
                                >
                                <span class="flex items-center gap-1"
                                    ><i
                                        class="bi bi-aspect-ratio text-emerald-600"
                                    ></i>
                                    {{ ls.room?.area }} m²</span
                                >
                                <span class="flex items-center gap-1"
                                    ><i
                                        class="bi bi-geo-alt text-emerald-600"
                                    ></i>
                        ...
                        <!-- View Stats -->
                        <div
                            class="flex items-center gap-4 text-[10px] text-slate-400 font-bold"
                        >
                            <span
                            ...
                            >
                            <span
                                ><i class="bi bi-calendar3 mr-1"></i> Ngày tạo:
                                {{
                    ...
                    >
                        <Link
                            :href="route('landlord.listings.edit', ls.id)"
        ...
        <!-- PHÂN TRANG -->
        <div
            v-if="listings.links && listings.links.length > 3"
