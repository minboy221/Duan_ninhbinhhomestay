        ...
        <div class="chitiettro-container">
            ...
            <div class="layout">
                    ...
                    <div class="container">
                        ...
                        <div class="detail_tro">
                            ...
                            <div class="thongtin_tro">
                                ...
                                <div class="bando">
                                    <h2>Vị trí &amp; Bản Đồ</h2>
                                    <iframe :src="roomMapUrl" width="100%" height="350"
                ...
                <section class="info_chutro">
                    <div class="baochutro">
                        ...
                        <div class="content_chutro">
                            ...
                            <div class="nhantin_chutro">
                                ...
                                <button v-if="!user || user.role !== 'landlord'" @click="openBookingModal"
                                    class="btn_mess" style="
                                    border: none;
                                    width: 100%;
                                    text-align: center;
                                    cursor: pointer;
                    ...
                    <!-- Khung Đánh giá từ người thuê bên cột phải (TÁCH BIỆT NẰM Ở DƯỚI BAOCHUTRO) -->
                    <div class="sidebar-reviews-card">
                        <h3 class="sidebar-reviews-title">
                            <i class="bi bi-chat-right-quote-fill"></i> Đánh giá từ người thuê
                        </h3>
                                    ...
                                    <div class="sidebar-review-author">
                                        ...
                                        <div>
                                            <div class="sidebar-review-author-info">
                                                ...
                                                <span v-if="rev.is_admin" class="sidebar-review-badge-admin">
                                                    Boss
                                                </span>
                                                <span v-else-if="rev.is_owner" class="sidebar-review-badge-owner">
                                                    Chủ trọ
                                                </span>
                                            </div>
                                            <p class="sidebar-review-time">
                                                {{ rev.created_at }}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div v-else class="sidebar-reviews-empty">
                            <i class="bi bi-chat-square-dots text-2xl text-slate-400 block mb-1"></i>
                            Chưa có đánh giá nào cho phòng này.
                        </div>

                        <!-- Form gửi bình luận (chỉ hiện nếu được phép) -->
                        <div v-if="canReview" class="sidebar-review-form-container">
                            <h4 class="sidebar-review-form-title">
