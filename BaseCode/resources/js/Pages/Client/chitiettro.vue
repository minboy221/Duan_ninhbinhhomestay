...
<template>
    <Head
        :title="(post?.title || 'Xem Chi Tiết Phòng') + ' | Ninh Bình HomeStay'"
    />
    <MainLayout>
        <div
            class="page-wrapper"
            style="padding-top: 100px; max-width: 1200px; margin: 0 auto"
        >
            <!-- điều hướng -->
            <div class="dieuhuong">
                <div class="baodieuhuong">
                        ...
                        <div class="detail_tro">
                            ...
                            <div class="infor_tro">
                                <div class="price_tro">
                                    <p>
                                        {{
                                            formatPrice(post.room?.price)
                                        }}/Tháng
                                    </p>
                                </div>

                                <div
                                    v-if="post.room?.status"
                                    style="
                                        margin-left: 10px;
                                        display: flex;
                                        align-items: center;
                                ...
                                <div class="trangthai">
                                    <p>
                                        Cập nhật: {{ timeAgo(post.updated_at) }}
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <span
                                    ><i class="bi bi-aspect-ratio"></i> Diện
                                    tích: {{ post.room?.area }} m²</span
                                >
                                <span
                                    ><i class="bi bi-people"></i> Sức chứa:
                                    {{ post.room?.capacity }} người</span
                                >
                            </div>
                            ...
                            <div class="thongtin_tro">
                                ...
                                <div
                                    ...
                                    v-if="
                                        post.room?.services &&
                                        post.room.services.length
                                    "
                                >
                                    <div
                                        class="baotienich"
                                        v-for="service in post.room.services"
                                        :key="service.id"
                                    >
                                        <i
                                            :class="[
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p style="margin: 0; font-size: 15px">
                                        Khu trọ này chưa có bình luận nào.
                                    </p>
                                    <p
                                        style="
                                            margin: 5px 0 0 0;
                                        ...
                                        "
                                    >
                                        Hãy là người đầu tiên trải nghiệm và
                                        đánh giá nhé!
                                    </p>
                                </div>
                ...
                <section class="info_chutro">
                    <div class="baochutro">
                        <div class="avatar1">
                            <div class="avatar-img">
                                <img
                                    :src="getAvatarUrl(post.landlord?.avatar)"
                                    alt=""
                                    style="object-fit: cover"
                                />
                                <span class="status1 online"></span>
                    ...
                    >
                        <div class="img">
                            ...
                            <span class="count"
                                ...
                                {{ sp.image ? sp.image.length : 0 }}</span
                            >
                        </div>
                        <div class="content">
                            <h3
                            ...
                            >
                                ...
                                {{
                                    sp.room?.boarding_house?.address_detail ||
                                    "Đang cập nhật"
                                }}
                            </p>
                        </div>
