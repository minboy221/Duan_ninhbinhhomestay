    ...
    <MainLayout>
        ...
        <div class="layout">
            ...
            <section class="info_chutro">
                ...
                <!-- Phần Bình Luận / Đánh giá chuyển lên dưới thông tin chủ trọ -->
                <section class="reviews-section" style="margin-top: 20px; width: 100%; max-width: 325px;">
                    <div style="background: #fff; border-radius: 20px; padding: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.08); border: 1px solid rgba(226, 232, 240, 0.8);">
                        <h3
                            style="font-size: 16px; font-weight: 700; margin-bottom: 16px; display: flex; align-items: center; gap: 8px; color: #0f172a;">
                        ...
                        <div v-if="room.reviews && room.reviews.length > 0"
                            style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 20px; max-height: 400px; overflow-y: auto;" class="custom-scrollbar">
                            <div v-for="rev in room.reviews" :key="rev.id"
                                :style="rev.is_notice ? 'padding: 12px; background: #fef2f2; border-radius: 10px; border: 1px solid #fee2e2; border-left: 4px solid #ef4444;' : 'padding: 12px; background: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0;'">
                                <div
                                    style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px;">
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        <div
                                            style="width: 34px; height: 34px; border-radius: 50%; overflow: hidden; background: #e2e8f0; display: flex; align-items: center; justify-content: center; font-weight: bold; color: #64748b; flex-shrink: 0;">
                                            ...
                                            <span v-else style="font-size: 13px;">{{ rev.tenant_name ? rev.tenant_name[0].toUpperCase() : 'U' }}</span>
                                        </div>
                                        <div>
                                            <div style="display: flex; align-items: center; gap: 6px; flex-wrap: wrap;">
                                                ...
                                                <span v-if="rev.is_notice"
                                                    style="background: rgba(239,68,68,0.15); color: #ef4444; font-size: 9px; padding: 2px 5px; border-radius: 4px; font-weight: 700;">
                                                    <i class="bi bi-megaphone-fill"></i> Tin quan trọng
                                                </span>
                                                <span v-if="rev.is_admin"
                                                    style="background: #ef4444; color: #fff; font-size: 9px; padding: 2px 5px; border-radius: 12px; font-weight: 700;">
                                    ...
                                    <div v-if="!rev.is_notice" style="color: #fbbf24; font-size: 12px;">
                        ...
                        <div v-else
                            style="text-align: center; padding: 20px 10px; color: #94a3b8; background: #f8fafc; border-radius: 10px; margin-bottom: 20px; font-size: 13px;">
                        ...
                        <div v-if="canReview" style="border-top: 1px solid #e2e8f0; padding-top: 16px;">
                            ...
                            <form @submit.prevent="submitDirectReview">
                                <div v-if="!isNoticeSender" style="margin-bottom: 12px;">
                                    <label style="display: block; font-size: 12px; color: #475569; margin-bottom: 4px;">Đánh giá (Sao)</label>
                                    <div style="display: flex; gap: 6px; font-size: 20px; cursor: pointer; color: #cbd5e1;">
                                ...
                                <div style="margin-bottom: 12px;">
                                    <label style="display: block; font-size: 12px; color: #475569; margin-bottom: 4px;">
                                    ...
                                    <textarea v-model="reviewForm.comment" rows="3"
                                        ...
                                        style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px; outline: none; font-size: 13px; resize: vertical; box-sizing: border-box;"></textarea>
                                ...
                                <button type="submit" :disabled="reviewForm.processing"
                                    :style="isNoticeSender
                                        ? 'background: #ef4444; color: #fff; width: 100%; padding: 9px; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; transition: background 0.2s; display: flex; align-items: center; justify-content: center; gap: 6px; font-size: 13px;'
                                        : 'background: #7c3aed; color: #fff; width: 100%; padding: 9px; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; transition: background 0.2s; display: flex; align-items: center; justify-content: center; gap: 6px; font-size: 13px;'">
