            ...
            >
                ...
                <div class="space-y-3">
                    ...
                    <div
                        ...
                        v-if="boardingHouse?.contract_images?.length"
                    >
                        <div
                            v-for="(
                                path, index
                            ) in boardingHouse.contract_images"
                            :key="'contract-' + index"
                ...
                <div class="space-y-3 border-t border-gray-100 pt-5">
                    ...
                    <div
                        ...
                        v-if="boardingHouse?.room_images?.length"
                    >
                        <div
                            v-for="(path, index) in boardingHouse.room_images"
                            :key="'room-' + index"
                    ...
                    >
                        <h4
                            class="text-sm font-bold text-green-700 flex items-center gap-2"
                        >
                        ...
                        <p
                            class="text-xs text-blue-600 font-bold bg-blue-50 p-2 rounded"
                        >
                        ...
                        <div
                            class="rounded-xl overflow-hidden border border-green-200 shadow-sm mt-2"
                        >
                            <iframe
                                width="100%"
                                height="250"
                    ...
                    <!-- Warning -->
                    <div
                        v-else-if="boardingHouse?.room_images?.length"
