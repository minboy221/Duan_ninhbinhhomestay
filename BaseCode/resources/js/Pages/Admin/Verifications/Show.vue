    ...
    <AdminLayout>
        ...
        >
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div
                        class="flex flex-col sm:flex-row sm:items-center gap-x-4 gap-y-1 mt-1"
                    >
                        <p
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
                ...
                <div
                    class="grid grid-cols-2 gap-4 bg-gray-50 p-4 rounded-xl text-sm border border-gray-100"
                >
                    <div>
                        <span
                            class="text-gray-500 block text-[11px] font-bold uppercase tracking-wider mb-1"
                            >Số điện thoại</span
                        >
                        <span
                            class="font-bold text-gray-900 text-base flex items-center gap-1.5"
                        >
                    ...
                    <div>
                        <span
                            class="text-gray-500 block text-[11px] font-bold uppercase tracking-wider mb-1"
                            >Số CCCD / Định danh</span
                        >
                        <span
                            class="font-bold text-gray-900 text-base tracking-wider"
                            >{{
                ...
                <div
                    class="p-4 rounded-xl flex items-center justify-between shadow-sm"
                    :class="
                ...
                >
                    ...
                    <span
                        class="px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider shadow-sm"
                        :class="
                            verification?.kyc_status === 'approved'
                ...
                <div class="space-y-4 pt-2">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="text-center group">
                            <span
                                class="text-[11px] font-bold text-gray-500 block mb-2 uppercase tracking-wider"
                                >CCCD MẶT TRƯỚC</span
                            >
                            <div
                                class="relative overflow-hidden rounded-xl border border-gray-200 shadow-sm cursor-pointer"
                                @click="
                                    openImage(
                                        getPrivateImageUrl(
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="bi bi-zoom-in text-white text-2xl opacity-0 group-hover:opacity-100 transition duration-300"
                                    ></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        class="text-center border-t border-gray-100 pt-6 mt-4 relative"
                    >
                        <span
                            class="absolute -top-3 left-1/2 -translate-x-1/2 bg-white px-2 text-[11px] font-bold text-gray-400 uppercase tracking-wider"
                            >ẢNH CHỤP THỰC TẾ</span
                        >
                        <div
            ...
            >
                ...
                <div
                    class="space-y-4 bg-gray-50 p-5 rounded-xl text-sm border border-gray-100"
                >
                    <div>
                        <span
                            class="text-gray-500 block text-[11px] font-bold uppercase tracking-wider mb-1"
                            >Tên cơ sở trọ / Homestay</span
                        >
                ...
                <div class="space-y-3">
                    ...
                    >
                        <i
                            class="bi bi-file-earmark-text-fill text-gray-400"
                        ></i>
                    ...
                    >
                        <div
                            v-for="(path, index) in normalizeImages(
                        ...
                        >
                            <img
                                :src="getPrivateImageUrl(path, 'contracts')"
                            ...
                            >
                                <i
                                    class="bi bi-zoom-in text-white text-xl opacity-0 group-hover:opacity-100"
                                ></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-3 border-t border-gray-100 pt-5">
                    ...
                    >
                        ...
                        >
                            ...
                            <video
                                v-if="isVideo(path)"
                                :src="getPrivateImageUrl(path, 'rooms')"
                                controls
                    ...
                    <!-- GPS Map Section -->
                    <div
                        class="space-y-3 border-t pt-4 mt-4"
                        v-if="
                    ...
                    >
                        <div class="flex items-center justify-between">
                            ...
                            >
                                <i
                                    class="bi bi-geo-alt-fill text-emerald-600"
                                ></i>
                        ...
                        <div
                            class="bg-emerald-50/80 p-3 rounded-xl border border-emerald-200 space-y-2"
                        >
                            <div
                            ...
                            >
                                <div class="space-y-0.5">
                                    <p class="font-bold text-emerald-950">
                                        Thập phân:
                                        <span
                                            class="font-mono text-emerald-700 font-bold"
                                            >{{
                                                Number(
                                    ...
                                    <p
                                        class="text-emerald-800 text-[11px] font-medium"
                                    >
                                        DMS:
                                        {{
                            ...
                            <div
                                class="flex items-center gap-1.5 pt-1 border-t border-emerald-200/60 text-xs"
                            >
                                <span class="text-gray-500 text-[11px] mr-1"
                                    >Chế độ xem:</span
                                >
                                <button
                                    type="button"
                                    @click="activeMapLayer = 'osm'"
                                    :class="
                                        activeMapLayer === 'osm'
                        ...
                        <!-- Map Frame -->
                        <div
                            class="rounded-xl overflow-hidden border border-emerald-200 shadow-sm relative h-64 bg-gray-100"
                        >
                            <!-- OpenStreetMap with Marker Pinpoint -->
                            <iframe
                                v-if="activeMapLayer === 'osm'"
                                width="100%"
                                height="100%"
                                style="border: 0"
                                loading="lazy"
                                :src="
                                    ...
                                    (Number(boardingHouse.longitude) - 0.0035) +
                                    '%2C' +
                                    (Number(boardingHouse.latitude) - 0.0022) +
                                    '%2C' +
                                    (Number(boardingHouse.longitude) + 0.0035) +
                                    '%2C' +
                                    (Number(boardingHouse.latitude) + 0.0022) +
                            ...
                            <iframe
                                v-else-if="activeMapLayer === 'satellite'"
                                width="100%"
                                height="100%"
                                style="border: 0"
                                loading="lazy"
                        ...
                        <div class="flex flex-wrap items-center gap-2 pt-1">
                            ...
                            >
                                <i
                                    class="bi bi-box-arrow-up-right text-emerald-600"
                                ></i>
                                Mở Google Maps
                            </a>
                            <a
                            ...
                            >
                                <i
                                    class="bi bi-globe-americas text-purple-600"
                                ></i>
                                Xem vệ tinh 3D
                            </a>
                        </div>
                    ...
                    <div v-else class="space-y-3 border-t pt-4 mt-4">
                        ...
                        >
                            <i
                                class="bi bi-exclamation-triangle-fill text-amber-600 text-base mt-0.5"
                            ></i>
                            <div>
                                <p class="font-bold">
        ...
        >
            ...
            >
                <div class="p-6">
                    ...
                    >
                        <i
                            class="bi bi-exclamation-triangle-fill text-red-600 text-xl"
                        ></i>
                    </div>
                    <h3
                        class="text-lg font-bold text-center text-gray-900 mb-2"
                    >
                        Từ chối hồ sơ
                    </h3>
                    <p class="text-sm text-center text-gray-500 mb-6">
                        ...
                        >. Vui lòng cung cấp lý do để gửi cho chủ trọ.
                    </p>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Ví dụ: Ảnh CCCD bị mờ, không khớp khuôn mặt..."
                        ></textarea>
                    </div>
                </div>
                <div
                    class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3 border-t"
                >
                    <button
        ...
        >
            ...
            >
                <div class="p-6">
                    <div
                        class="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-4"
                    >
                        <i
                            class="bi bi-check-lg text-green-600 text-2xl font-bold"
                        ></i>
                    </div>
                    <h3
                        class="text-lg font-bold text-center text-gray-900 mb-2"
                    ...
                    <div
                        class="bg-blue-50 p-3 rounded-lg text-sm text-blue-800 text-center mt-4"
                    >
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    ...
                    >
                        <i
                            class="bi bi-check2 text-white text-5xl absolute"
                        ></i>
                        <div
                            class="absolute inset-0 rounded-full border-4 border-green-200 animate-ping opacity-20"
                        ></div>
                    </div>
                    <h3
                        class="text-xl font-bold text-gray-900 mb-2 font-headline"
                    >
                        Thành công!
                    </h3>
