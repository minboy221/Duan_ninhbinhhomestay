        ...
        <template #header-title>
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Danh sách các tài khoản đang chờ kiểm duyệt KYC và hồ sơ nhà
                    trọ.
                </p>
            </div>
        </template>
            ...
            >
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            >
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div
                                                class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-sm"
                                            >
                                                {{
                                                    user.name
                                                        .charAt(0)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div
                                        class="text-sm text-gray-900 font-medium flex items-center gap-1.5"
                                    >
                                        <i
                                            class="bi bi-telephone-fill text-gray-400 text-xs"
                                        ></i>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="bi bi-check-circle-fill text-[10px]"
                                        ></i>
                                        AI Đã Khớp
                                    </span>
                                    <span
                    ...
                    >
                        ...
                        >
                            <i
                                class="bi bi-inbox-fill text-gray-400 text-2xl"
                            ></i>
                        </div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Hiện tại chưa có hồ sơ chủ trọ nào đang chờ duyệt.
                        </p>
                    </div>
                </div>
            </div>
