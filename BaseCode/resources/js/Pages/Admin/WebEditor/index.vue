...
.section-card{background:#fff;border-radius:14px;border:1px solid #f1f5f9;padding:20px;box-shadow:0 1px 3px rgba(0,0,0,.05)}
.sec-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:16px}
.sec-title{font-size:14px;font-weight:700;color:#0f172a;margin:0;display:flex;align-items:center;gap:7px}
.btn-sm-add{padding:7px 12px;border-radius:9px;border:none;background:#7c3aed;color:#fff;font-size:12px;font-weight:600;cursor:pointer;display:flex;align-items:center;gap:5px}
.banner-list{display:flex;flex-direction:column;gap:10px}
.banner-item{display:flex;align-items:center;gap:12px;padding:12px;background:#f8fafc;border-radius:12px;border:1px solid #f1f5f9}
.banner-thumb{width:80px;height:50px;border-radius:8px;background:#e2e8f0;display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0}
.banner-thumb img{width:100%;height:100%;object-fit:cover}
.banner-info{flex:1}
.banner-title-input{width:100%;border:1px solid #e2e8f0;border-radius:8px;padding:5px 8px;font-size:13px;font-weight:600;color:#0f172a;outline:none;background:#fff;box-sizing:border-box}
...
.act-btn{width:32px;height:32px;border-radius:8px;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:14px;transition:all .15s}
...
.form-input{width:100%;padding:9px 12px;border:1px solid #e2e8f0;border-radius:10px;font-size:13px;outline:none;box-sizing:border-box;color:#0f172a}
.form-input:focus{border-color:#7c3aed}
.form-textarea{width:100%;padding:9px 12px;border:1px solid #e2e8f0;border-radius:10px;font-size:13px;outline:none;resize:none;box-sizing:border-box}
.form-textarea:focus{border-color:#7c3aed}
.save-btn{width:100%;padding:12px;border-radius:12px;border:none;background:#7c3aed;color:#fff;font-size:14px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:7px;transition:all .2s}
.save-btn:hover{background:#6d28d9}.saved{background:#22c55e}
.preview-panel{background:#fff;border-radius:14px;border:1px solid #f1f5f9;padding:16px;box-shadow:0 1px 3px rgba(0,0,0,.05);position:sticky;top:24px}
.preview-title{font-size:13px;font-weight:700;color:#64748b;margin:0 0 12px;text-transform:uppercase;letter-spacing:.05em}
.preview-box{border:1px solid #e2e8f0;border-radius:10px;overflow:hidden}
