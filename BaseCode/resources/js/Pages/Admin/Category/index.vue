        ...
        <div class="cat-layout">
            ...
            <div class="cat-sidebar">
                <button v-for="tab in tabs" :key="tab.key" @click="activeTab = tab.key"
                    ...
                    <i
                        :class="['bi', tab.key === 'types' ? 'bi-tags-fill' : tab.key === 'areas' ? 'bi-geo-alt-fill' : 'bi-stars']"></i>
                    {{ tab.label }}
            ...
            <div class="cat-content">
                ...
                <div v-else class="cat-grid">
                    <div v-for="item in data[activeTab]" :key="item.id" class="cat-card"
                        :class="!item.is_active ? 'cat-inactive' : ''">
                        ...
                        <div class="cat-info">
                            ...
                            <p v-if="activeTab === 'areas'"
                                :class="item.map_embed ? 'cat-map-badge' : 'cat-map-badge-missing'">
            ...
            <div v-if="showForm" class="modal-overlay" @click.self="showForm = false">
                <div class="modal-box">
                    <div class="modal-header">
                        <h3>{{ editItem ? 'Chỉnh Sửa' : 'Thêm Mới' }} {{tabs.find(t => t.key === activeTab)?.label}}
                        </h3>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input v-model="formData.name" @keyup.enter="saveItem" type="text" class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <div class="icon-input-wrap">
                                ...
                                <input v-model="formData.icon" type="text" class="form-input"
                                    placeholder="VD: bi-wifi, bi-house..." />
                            </div>
                        </div>
                        ...
                        <div v-if="activeTab === 'areas'" class="form-group">
                            ...
                            <p class="form-hint">Vào Google Maps → Chọn địa điểm → Chia sẻ → Nhúng bản đồ → Copy mã
                                iframe</p>
                            <textarea v-model="formData.map_embed" class="form-textarea" rows="4"
                                placeholder='Dán mã iframe từ Google Maps vào đây... VD: <iframe src="https://www.google.com/maps/embed?..."></iframe>'></textarea>
...
.map-preview-wrap {
    ...
    box-shadow: 0 0 15px 4px rgba(124, 58, 237, 0.15), 0 4px 20px rgba(0, 0, 0, 0.08);
}

.map-preview-wrap :deep(iframe) {
    width: 100%;
    height: 350px;
    border: none;
    display: block;
