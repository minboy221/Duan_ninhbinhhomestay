                        ...
                        <form v-else-if="activeTab === 'signup'" @submit.prevent="submitSignup" class="space-y-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input v-model="signupForm.email" type="email" placeholder="example@gmail.com"
                                        class="w-full bg-white border-none rounded-xl py-4 pl-12 pr-4 focus:ring-4 focus:ring-[#57baf6]/30 transition-all text-[#2c2f31] outline-none" />
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <img :src="captchaUrl" alt="captcha" class="rounded-xl h-[56px] cursor-pointer self-start border border-gray-200" @click="reloadCaptcha" title="Bấm vào để đổi mã" />
                                </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-start gap-3 py-2">
                                    ...
                                    <span class="text-sm text-[#595c5e] leading-relaxed">
                                        Tôi đồng ý với
                                        <a href="#"
                                            class="text-[#00628c] font-semibold underline underline-offset-4">Điều
                                            khoản dịch vụ</a>
                                        và
                                        <a href="#"
                                            class="text-[#00628c] font-semibold underline underline-offset-4">Chính
                                            sách bảo mật</a>.
                                    </span>
                                </div>
