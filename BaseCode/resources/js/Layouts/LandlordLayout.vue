...
<template>
    <div
        class="landlord-layout flex h-screen overflow-hidden bg-[#fafbfe] font-sans text-slate-700 antialiased"
    >
        ...
        >
            <!-- Brand logo -->
            <div
                class="flex items-center gap-3 px-5 py-4 border-b border-slate-100/60 h-16 flex-shrink-0"
            >
                <div
                ...
                >
                    <span
                        class="font-extrabold text-slate-900 text-sm tracking-tight whitespace-nowrap"
                        >Ninh Bình Home</span
                    >
                    <span
                        class="text-emerald-600 text-[10px] font-extrabold tracking-wide uppercase whitespace-nowrap"
                        >Chủ Trọ Panel</span
                    >
                </div>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        class="h-px bg-slate-100/80 my-4 mx-2"
                    ></div>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <div v-else class="space-y-1">
                                ...
                                <div
                                    v-if="sidebarOpen && isSubmenuOpen(item)"
        ...
        <div class="flex flex-col flex-1 overflow-hidden min-w-0">
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <button
                        class="md:hidden text-slate-500 hover:bg-slate-50 p-2 rounded-xl"
                    ...
                    >
                        ...
                        >
                        <kbd
                            class="ml-auto bg-white border border-slate-200/60 rounded px-1.5 py-0.5 text-[9px] font-mono text-slate-400/80 shadow-sm"
                            >⌘K</kbd
                        >
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <i
                                class="bi bi-chevron-down text-[9px] text-slate-400 ml-1"
                            ></i>
                        </button>
                        ...
                        >
                            <div
                                class="px-4 py-1.5 text-[9px] font-bold text-slate-400/80 tracking-widest uppercase"
                            >
                                Chọn Cơ Sở
                            </div>
                            <button
                            ...
                            >
                                <i
                                    class="bi bi-geo-alt-fill text-emerald-500 mr-2"
                                ></i>
                                {{ prop.name }}
                            </button>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                        ...
                                        >
                                            <div class="flex gap-3 items-start">
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="text-xs text-slate-500 mb-1 leading-relaxed"
                                                    >
                                                        {{
                                                            notification.data
                                                                .message ||
                                    ...
                                    >
                                        <i
                                            class="bi bi-bell-slash text-slate-300 text-3xl"
                                        ></i>
                                        <p
                    ...
                    <!-- User Profile info -->
                    <div
                        class="flex items-center gap-3 pl-3 border-l border-slate-100"
                    >
                        <img
                            v-if="user?.avatar"
                            :src="getAvatarUrl(user.avatar)"
                            class="w-9 h-9 rounded-xl object-cover border border-slate-200 shadow-sm"
                            alt="Avatar"
                        />
                        <div
                            v-else
                        ...
                        <div class="hidden lg:flex flex-col">
                            <span
                                ...
                                >{{ user?.name || "Chủ trọ" }}</span
                            >
                            <span
                                class="text-[9px] font-extrabold text-emerald-600 mt-1 uppercase tracking-wide"
                                >Chủ Trọ</span
                            >
                        </div>
                    </div>
            ...
            <!-- Main view screen -->
            <main
                class="flex-1 overflow-y-auto px-6 pt-6 pb-28 md:p-8 bg-[#f8fafc] text-sm"
            >
                <slot />
            </main>
        </div>
    ...
    <Teleport to="body">
        <div
            v-if="drawerOpen"
            class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex"
            @click.self="closeDrawer"
        >
            <div
                class="w-72 h-full bg-[#f1f5f9] flex flex-col shadow-2xl animate-slide-in"
            >
                <!-- Drawer Head -->
                <div
                    class="flex items-center gap-3 px-5 py-4 border-b border-slate-100 h-16 flex-shrink-0"
                >
                    <div
                    ...
                    <div class="flex flex-col">
                        <span class="font-bold text-slate-800 text-sm"
                            >Ninh Bình Stay</span
                        >
                        <span class="text-emerald-500 text-xs font-semibold"
                            >Chủ Trọ Panel</span
                        >
                    </div>
                    <button
                        class="ml-auto text-slate-400 hover:text-slate-600 p-2"
                        @click="closeDrawer"
                    >
    ...
    <Teleport to="body">
        <Transition name="toast-slide">
            <div
                v-if="showFlash"
                style="position: fixed; top: 30px; right: 30px; z-index: 99999"
            >
                <div
                    style="
                        background: white;
        ...
        <Transition name="toast-slide">
            ...
            >
                ...
                >
                    ...
                    <div
                        :style="
                            latestNotification?.type === 'listing_rejected' ||
                        ...
                        >
                            ...
                            <div style="flex: 1; min-width: 0">
                                ...
                                <div style="display: flex; gap: 10px">
                                    <Link
                                        v-if="latestNotification?.data?.url"
